...
increase_priority_button = Button(root,text="Move up",width=13,command=increase_priority)
increase_priority_button.grid(row=5,column=0,pady=5)

decrease_priority_button = Button(root,text="Move down",width=13,command=decrease_priority)
decrease_priority_button.grid(row=5,column=1,pady=5)

clear_completed_button = Button(root,text="Clear Completed Tasks",width=31,command=clear_completed_tasks)
...
status = Label(root,textvariable=statusvar,bd=1,relief=SUNKEN,anchor=E)
